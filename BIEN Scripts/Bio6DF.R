...
#create new df
AsiminaCoord$bio6=bio6_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio6_Asimina_data
histogram(~bio6|scrubbed_species_binomial, data=AsiminaCoord)
