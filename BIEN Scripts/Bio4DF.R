...
#create new df
AsiminaCoord$bio4=bio4_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio4_Asimina_data
histogram(~bio4|scrubbed_species_binomial, data=AsiminaCoord)
