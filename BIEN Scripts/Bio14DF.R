...
#create new df
AsiminaCoord$bio14=bio14_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio14_Asimina_data
histogram(~bio14|scrubbed_species_binomial, data=AsiminaCoord)
