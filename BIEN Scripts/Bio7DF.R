...
#create new df
AsiminaCoord$bio7=bio7_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio7_Asimina_data
histogram(~bio7|scrubbed_species_binomial, data=AsiminaCoord)
