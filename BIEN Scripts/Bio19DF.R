...
#create new df
AsiminaCoord$bio19=bio19_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio19_Asimina_data
histogram(~bio19|scrubbed_species_binomial, data=AsiminaCoord)
