...
#create new df
AsiminaCoord$bio10=bio10_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio10_Asimina_data
histogram(~bio10|scrubbed_species_binomial, data=AsiminaCoord)
