...
#create new df
AsiminaCoord$bio5=bio5_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio5_Asimina_data
histogram(~bio5|scrubbed_species_binomial, data=AsiminaCoord)
