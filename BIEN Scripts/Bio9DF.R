...
#create new df
AsiminaCoord$bio9=bio9_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio9_Asimina_data
histogram(~bio9|scrubbed_species_binomial, data=AsiminaCoord)
