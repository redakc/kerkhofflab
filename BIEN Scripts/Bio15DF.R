...
#create new df
AsiminaCoord$bio15=bio15_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio15_Asimina_data
histogram(~bio15|scrubbed_species_binomial, data=AsiminaCoord)
