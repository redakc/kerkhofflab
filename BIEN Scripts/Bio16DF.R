...
#create new df
AsiminaCoord$bio16=bio16_Asimina_data
AsiminaCoord=subset(AsiminaCoord, is.na(longitude)==0, drop=TRUE)
Asimina2Coord=bio16_Asimina_data
histogram(~bio16|scrubbed_species_binomial, data=AsiminaCoord)
